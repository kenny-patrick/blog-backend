...
describe('when there is initially one user in db', () => {
  ...
  test('creation fails if username or password does not have minimum length of 3', async () => {
    ...
    expect(resultBadUsername.body.error).toContain('username and password must be at least 3 characters long')
    ...
    expect(resultBadPassword.body.error).toContain('username and password must be at least 3 characters long')
